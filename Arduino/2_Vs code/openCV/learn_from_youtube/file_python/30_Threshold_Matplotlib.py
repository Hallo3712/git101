...
img = cv2.imread("image/gradient_2.jpg", 1)  # โหลดภาพแบบสี
...
images = [img, gray_img, result1, result2, result3, result4, result5]
titles = ['Original Image', 'Gray Image', 'Binary', 'Binary Inv', 'Trunc', 'To Zero', 'To Zero Inv']

plt.figure('30_Threshold_Matplotlib', figsize=(6, 6))
