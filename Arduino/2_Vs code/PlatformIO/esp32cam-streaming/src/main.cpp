...
bool checkCamera()
{
    ...
    config.frame_size = FRAMESIZE_QVGA; // 320x240, เพื่อความเร็วในการสตรีม
...
{
    Serial.begin(115200);
    Serial.println("Starting camera setup...");
    ...
    server.on("/", HTTP_GET, [](AsyncWebServerRequest *request)
              { request->send(200, "text/html",
                              "<html><body><h1>📷 ESP32-CAM Live Stream</h1>"
